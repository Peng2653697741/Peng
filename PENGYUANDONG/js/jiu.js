$(function(){
	$.ajax({
		...
		success:function(aa,bb){
			...
			$(".img1").prop({src:aa[0].jiu.tup3})
			$(".wb1").text(aa[0].hanbaobaowb.wb1)
			$(".wb-div-2").text(aa[0].jiu.wb2)
			$(".wb-div-3").text(aa[0].jiu.wb3)
			$(".wb-div-d1-1").text(aa[0].jiu.wb4)
			$(".wb-div-d1-2").text(aa[0].jiu.wb5)
			$(".wb-div-d2-1").text(aa[0].jiu.wb6)
			$(".wb-div-d2-2").text(aa[0].jiu.wb7)
			$(".wb-div-d3-1").text(aa[0].jiu.wb8)
			$(".wb-div-d3-2").text(aa[0].jiu.wb9)
			$(".tu1-1").prop({src:aa[0].jiu.tup6})
			$(".tu2-1").prop({src:aa[0].jiu.tup5})
			$(".tu3-1").prop({src:aa[0].jiu.tup4})
			$(".tu4-1").prop({src:aa[0].jiu.tup1})
			$(".tu5-1").prop({src:aa[0].jiu.tup2})
			$(".tu6-1").prop({src:aa[0].jiu.tup8})
			$(".tu7-1").prop({src:aa[0].jiu.tup7})
			$(".tu8-1").text(aa[0].jiu.wb10)
			$(".tu9-1").text(aa[0].jiu.wb11)
			$(".tu10-1").text(aa[0].jiu.wb12)
