$(function(){
	$.ajax({
		...
		success:function(aa,bb){
			...
			$(".img1").prop({src:aa[0].hanbaobaotu.tup1})
			$(".wb1").text(aa[0].hanbaobaowb.wb1)
			$(".wb-div-2").text(aa[0].hanbaobaowb.wb2)
			$(".wb-div-3").text(aa[0].hanbaobaowb.wb3)
			$(".wb-div-d1-1").text(aa[0].hanbaobaowb.wb4)
			$(".wb-div-d1-2").text(aa[0].hanbaobaowb.wb5)
			$(".wb-div-d2-1").text(aa[0].hanbaobaowb.wb6)
			$(".wb-div-d2-2").text(aa[0].hanbaobaowb.wb7)
			$(".wb-div-d3-1").text(aa[0].hanbaobaowb.wb8)
			$(".wb-div-d3-2").text(aa[0].hanbaobaowb.wb9)
			$(".tu1-1").prop({src:aa[0].hanbaobaotu.tup2})
			$(".tu2-1").prop({src:aa[0].hanbaobaotu.tup8})
			$(".tu3-1").prop({src:aa[0].hanbaobaotu.tup6})
			$(".tu4-1").prop({src:aa[0].hanbaobaotu.tup3})
			$(".tu5-1").prop({src:aa[0].hanbaobaotu.tup7})
			$(".tu6-1").prop({src:aa[0].hanbaobaotu.tup4})
			$(".tu7-1").prop({src:aa[0].hanbaobaotu.tup5})
			$(".tu8-1").text(aa[0].hanbaobaowb.wb10)
			$(".tu9-1").text(aa[0].hanbaobaowb.wb11)
			$(".tu10-1").text(aa[0].hanbaobaowb.wb12)
	...
	$("<div class='tu1'></div>").width("1200px").height("632px").appendTo(".zhongjian")
	...
	$("<div class='tu5'></div>").width("1200px").height("632px").css({float:"left"}).appendTo(".zhongjian")
	$("<img class='tu5-1'/>").width("1200px").height("632px").css({marginTop:"30px"}).appendTo(".tu5")
	$("<div class='tu6'></div>").width("1200px").height("632px").css({float:"left"}).appendTo(".zhongjian")
	...
	$("<div class='tu8'></div>").width("150px").height("50px").css({margin:"150px auto"}).appendTo(".zhongjian")
	$("<span class='tu8-1'></span>").width("100px").height("30px").css({fontSize:"0.8em",color:"#465863"}).appendTo(".tu8")
	$("<div class='tu9'></div>").width("650px").height("50px").css({margin:"0 auto"}).appendTo(".zhongjian")
